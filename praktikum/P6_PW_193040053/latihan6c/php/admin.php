...
<body>
    ...
    <br><br>
    <div class="row">
    <div class="col s4"><a href="tambah.php" class="waves-effect waves-light blue darken-1 btn-small">Tambah Data</a></div>
	</div>
    <div class="row">
	<table border="1" cellpadding="13" cellspacing="0" class="responsive-table striped left">
		<tr>
			<th>#</th>
			<th>Opsi</th>
			<th>Cover</th>
		...
		<?php foreach ($buku as $b) :?>
			<tr>
				<td><?= $i; ?></td>
				<td>
					<a href="" class="waves-effect waves-light blue darken-1 btn-large">Ubah</a>
