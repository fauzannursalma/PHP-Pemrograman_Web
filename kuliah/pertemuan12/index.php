...
<body>
  ...
  <div class="container" id="mahasiswa">
    ...
    <div class="row">
      ...
      <div class="col m4 s12">
          <button type="submit" name="cari" class="waves-effect waves-light blue darken-1 btn-small left">Cari</button>
      </div>
      <div class="col m4 s12">
         <a href="tambah.php" class="waves-effect waves-light blue darken-4 btn-small right">Tambah Data Mahasiswa</a>
      </div>
      </form>
    </div>
    <div class="row">
